...
* [`QUnit.test.if()`]({% link api/QUnit/test.if.md %}) to automatically skip a test when a condition is false.
* [`QUnit.reporters.perf`]({% link api/reporters/perf.md %}) to find and analyze slow tests in your browser DevTools.
...
This warning was introduced in QUnit 2.15 ([#1576](https://github.com/qunitjs/qunit/issues/1576)) and has been promoted to [an error]({% link api/QUnit/module.md %}#E0002):
...
This warning was introduced in QUnit 2.17 ([#1377](https://github.com/qunitjs/qunit/issues/1377)) and has been promoted to [an error](https://qunitjs.com/api/config/autostart/#E0001):
...
QUnit 3 enables a default test timeout of 3 seconds. Check [config.testTimeout]({% link api/config/testTimeout.md %}#deprecated-no-timeout-set) for how to address this warning before upgrading to QUnit 3.
