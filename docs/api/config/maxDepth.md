...
| [QUnit 3.0.0](https://github.com/qunitjs/qunit/releases/tag/3.0.0) | Make `QUnit.dump.maxDepth` an alias for `QUnit.config.maxDepth`, allowing both to be read and changed at runtime.
