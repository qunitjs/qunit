...
<p class="lead lead--center">v2.24.0 (<a href="https://github.com/qunitjs/qunit/blob/2.24.0/History.md">changelog</a>)</p>

These are the official [release channels](intro.md#download) for QUnit:

* Download: [`qunit-2.24.0.js`](https://code.jquery.com/qunit/qunit-2.24.0.js) and [`qunit-2.24.0.css`](https://code.jquery.com/qunit/qunit-2.24.0.css)
