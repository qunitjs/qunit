QUnit.module( "beforeEach/afterEach", {
	...
	afterEach: function( assert ) {
		if ( this.hooksTest ) {
			assert.strictEqual( this.lastHook, "test-block", "Module's afterEach runs after " +
				"current test block" );
...
QUnit.test( "hooks order", function( assert ) {
	...
	assert.strictEqual( this.lastHook, "module-beforeEach", "Module's beforeEach runs before " +
		"current test block" );
