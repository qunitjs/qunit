...
QUnit.on( "runEnd", function() {
	...
	setTimeout( function() {
		QUnit.test( "test5", function( assert ) {
			...
			assert.equal( suiteStart, 6, "emitted suiteStart events" );
			assert.equal( testStart, 7, "emitted testStart events" );
			assert.equal( testEnd, 6, "emitted testEnd events" );
			assert.equal( suiteEnd, 5, "emitted suiteEnd events" );
...
QUnit.module( "grandparent module", function() {
