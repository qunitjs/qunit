/**
 * The structure test has an internal state so new instances must therefore be created for each test.
 */
function InterfaceStructure() {
	 ...
	 */
	this.equalStructure = function(actual, expected, message) {
	 ...
	 */
	this.deepEqualStructure = function(actual, expected, howdeep, message) {
	 ...
	 */
	this.notEqualStructure = function(actual, expected, message) {
		if(checkInterface(actual, expected)) {
	 ...
	 */
	this.notDeepEqualStructure = function(actual, expected, howdeep, message) {
		if(howdeep && isNaN(howdeep)) {	// this check is put here to give the correct line number
			throw new TypeError('the howdeep argument (argument 3) is not a number');
		}
		if(checkInterface(actual, expected, true, howdeep)) {
